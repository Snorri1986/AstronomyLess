...
$sql = "select mission_code,team_count,members_name,start_mission,end_mission,vehicle_arrive,vehicle_departure from iss_missions where mission_code = 'ISS-13-19'";
