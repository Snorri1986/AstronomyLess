...
/* test code 02.10.2019*/
$sql = "select rocket_name,height,diameter,mass,stages,payload,engines,thrust from vehicles where mission = 'Apollo 16&17'";
/* ... */
